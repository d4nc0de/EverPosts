    ...
    public partial class InitDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RelPostCategories", x => x.RelId);
                    table.ForeignKey(
                        name: "FK_RelPostCategories_Categories_CategorieId",
                        column: x => x.CategorieId,
                        principalTable: "Categories",
                        principalColumn: "CategorieId",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_RelPostCategories_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "PostId",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RelPostCategories_CategorieId",
                table: "RelPostCategories",
                column: "CategorieId");

            migrationBuilder.CreateIndex(
                name: "IX_RelPostCategories_PostId",
                table: "RelPostCategories",
                column: "PostId");
        }
